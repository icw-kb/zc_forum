<header class="bg-black text-white w-full">
    <div class="max-w-screen-xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        <nav class="flex items-center space-x-6">
            <a href="/forums" class="flex flex-col items-center">
                ...
                <span class="mt-1 text-sm">Community</span>
            </a>

            <a href="/plugins" class="flex flex-col items-center">
                <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                     viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M4 15v2a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-2m-8 1V4m0 12-4-4m4 4 4-4"/>
                </svg>
                <span class="mt-1 text-sm">Plugins</span>
            </a>

            <a href="https://github.com/zencart/zencart" class="flex flex-col items-center" target="_blank">
                ...
                <span class="mt-1 text-sm">Collaborate</span>
            </a>

            <a href="https://docs.zen-cart.com" class="flex flex-col items-center" target="_blank">
                <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                     viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M12 6.03v13m0-13c-2.819-.831-4.715-1.076-8.029-1.023A.99.99 0 0 0 3 6v11c0 .563.466 1.014 1.03 1.007 3.122-.043 5.018.212 7.97 1.023m0-13c2.819-.831 4.715-1.076 8.029-1.023A.99.99 0 0 1 21 6v11c0 .563-.466 1.014-1.03 1.007-3.122-.043-5.018.212-7.97 1.023"/>
                </svg>
                <span class="mt-1 text-sm">Learn</span>
            </a>
        </nav>
